    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreateDate", "FirstName", "LastName", "Role", "UpdateDate" },
                values: new object[] { 1, new DateTime(2023, 4, 19, 22, 15, 59, 622, DateTimeKind.Local).AddTicks(1705), "Muhammed", "Güler", 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
